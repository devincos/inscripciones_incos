...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($datos['id_carrera'])) {
        ...
        if ($carrera_nueva->ActualizarCarrera($datos['id_carrera'],$datos['nombre'], $datos['id_modalidad'], $datos['id_formacion_carr'], $datos['duracion'], $datos['fecha_creacion'], $datos['carga_horaria'])) {
            header("Location:" . Config::baseurl() . "views/carrera/lista.php?mensaje=$mensaje");
            exit();
